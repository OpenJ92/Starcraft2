...
class DataCommand(object):
    ...
    """Docstring for DataCommand. """

    def __init__(self, pid, player, frame, second, is_local, name, flags, flag, has_ability, ability_link, command_index, ability_data, ability_id, ability, ability_name, ability_type, ability_type_data, other_unit_id, other_unit, target_data):
        """TODO: to be defined.
